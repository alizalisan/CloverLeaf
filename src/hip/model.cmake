...
#    set(HIPCC_FLAGS  "-Xcompiler=-Xclang -Xcompiler=-load -Xcompiler=-Xclang -Xcompiler=${PERFFLOWASPECT_DIR}/lib64/libWeavePass.so")

    set(CMAKE_CXX_FLAGS "-I /opt/rocm-6.3.1/include -D__HIP_PLATFORM_AMD__ -fpass-plugin=${PERFFLOWASPECT_DIR}/lib64/libWeavePass.so" CACHE PATH "" FORCE)
    set(CMAKE_C_FLAGS "-I /opt/rocm-6.3.1/include -D__HIP_PLATFORM_AMD__ -fpass-plugin=${PERFFLOWASPECT_DIR}/lib64/libWeavePass.so" CACHE PATH "" FORCE)
