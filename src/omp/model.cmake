...
#     if (WITH_PERFFLOWASPECT)
    ...
    register_link_library(adiak::adiak)
#     endif()
    set(CMAKE_CXX_FLAGS "-flegacy-pass-manager -fpass-plugin=${PERFFLOWASPECT_DIR}/lib64/libWeavePass.so" CACHE PATH "" FORCE)
    set(CMAKE_C_FLAGS "-flegacy-pass-manager -fpass-plugin=${PERFFLOWASPECT_DIR}/lib64/libWeavePass.so" CACHE PATH "" FORCE)
